...
namespace server.Data.Migrations.Laberis
{
    ...
    [Migration("20250823060228_AddTaskStatusEnum")]
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "public", "annotation_type_enum", new[] { "bounding_box", "polygon", "polyline", "point", "text", "line" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "public", "asset_status_enum", new[] { "pending_import", "imported", "import_error", "pending_processing", "processing", "processing_error", "exported", "archived" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "public", "task_event_type_enum", new[] { "task_created", "task_assigned", "task_unassigned", "stage_changed", "status_changed", "comment_added", "annotation_created", "annotation_updated", "annotation_deleted", "review_submitted", "issue_raised", "priority_changed", "due_date_changed" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "public", "task_status_enum", new[] { "not_started", "in_progress", "completed", "archived", "suspended", "deferred", "ready_for_annotation", "ready_for_review", "ready_for_completion", "changes_required", "vetoed" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "public", "workflow_stage_type_enum", new[] { "annotation", "revision", "completion" });
            ...
            modelBuilder.Entity("server.Models.Domain.DashboardConfiguration", b =>
                {
                    b.Property<int>("DashboardConfigurationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("dashboard_configuration_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("DashboardConfigurationId"));
                    ...
                    b.HasKey("DashboardConfigurationId");
                    ...
                    b.ToTable("dashboard_configurations", (string)null);
                });
            ...
            modelBuilder.Entity("server.Models.Domain.EmailVerificationToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("server.Models.Domain.Task", b =>
                {
                    ...
                    b.Property<DateTime?>("DeferredAt")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<long>("WorkingTimeMs")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(0L)
                        .HasColumnName("working_time_ms");
