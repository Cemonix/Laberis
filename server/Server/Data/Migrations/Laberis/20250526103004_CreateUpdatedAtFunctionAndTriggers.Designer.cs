...
namespace server.Data.Migrations.Laberis
{
    ...
    [Migration("20250526103004_CreateUpdatedAtFunctionAndTriggers")]
    partial class CreateUpdatedAtFunctionAndTriggers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "public", "project_role_enum", new[] { "admin", "manager", "reviewer", "annotator", "viewer" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "public", "project_type_enum", new[] { "other", "image_classification", "object_detection", "image_segmentation", "video_annotation", "text_annotation" });
            ...
            modelBuilder.Entity("server.Models.Domain.Annotation", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "AnnotatorUser")
                        .WithMany()
            ...
            modelBuilder.Entity("server.Models.Domain.Task", b =>
                {
                    ...
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "LastWorkedOnByUser")
                        .WithMany()
