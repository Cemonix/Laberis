...
{
    /// <inheritdoc />
    public partial class UpdateWorkflowStageTypeEnum : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("CREATE TYPE public.workflow_stage_type_enum_new AS ENUM ('annotation', 'suspended', 'deferred', 'review', 'requires_changes', 'accepted');");
            ...
            migrationBuilder.Sql(@"
                ...
                SET stage_type_new = CASE 
                    WHEN stage_type = 'initial_import' THEN 'annotation'::public.workflow_stage_type_enum_new
                    WHEN stage_type = 'preprocessing' THEN 'annotation'::public.workflow_stage_type_enum_new
                    WHEN stage_type = 'annotation' THEN 'annotation'::public.workflow_stage_type_enum_new
                    WHEN stage_type = 'review' THEN 'review'::public.workflow_stage_type_enum_new
                    WHEN stage_type = 'quality_assurance' THEN 'review'::public.workflow_stage_type_enum_new
                    WHEN stage_type = 'auto_labeling' THEN 'annotation'::public.workflow_stage_type_enum_new
                    WHEN stage_type = 'export' THEN 'accepted'::public.workflow_stage_type_enum_new
                    WHEN stage_type = 'final_acceptance' THEN 'accepted'::public.workflow_stage_type_enum_new
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("CREATE TYPE public.workflow_stage_type_enum_old AS ENUM ('initial_import', 'preprocessing', 'annotation', 'review', 'quality_assurance', 'auto_labeling', 'export', 'final_acceptance');");
            ...
            migrationBuilder.Sql(@"
                ...
                SET stage_type_old = CASE 
                    ...
                    WHEN stage_type = 'suspended' THEN 'annotation'::public.workflow_stage_type_enum_old
                    WHEN stage_type = 'deferred' THEN 'annotation'::public.workflow_stage_type_enum_old
                    WHEN stage_type = 'review' THEN 'review'::public.workflow_stage_type_enum_old
                    WHEN stage_type = 'requires_changes' THEN 'annotation'::public.workflow_stage_type_enum_old
                    WHEN stage_type = 'accepted' THEN 'final_acceptance'::public.workflow_stage_type_enum_old
